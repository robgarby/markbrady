...
const DisplayPatientHistory = () => {
    ...
    // ────────────────────────────────────────────────────────────
    const reloadHistory = useCallback(async (patientID, hcn) => {
        ...
        <div className="container-fluid">
            <div className="d-flex align-items-center mb-2">
                ...
                <div className="ms-auto small text-muted">
                    {activePatient?.clientName || activePatient?.name} — {activePatient?.healthNumber}
                </div>
            </div>
                ...
                {LABS.map(([label, valueField, dateField]) => (
                    <div key={valueField} className="col-24">
                        <div className="border rounded p-2 d-flex align-items-center justify-content-between">
                            ...
                            <button
                                type="button"
                                className={`btn btn-sm ${valueCounts[valueField] > 0 ? "btn-outline-primary fw-bold" : "btn-outline-secondary"}`}
                                style={{ width: "200px" }}
                            ...
                            {editRows.length === 0 ? (
                                ...
                                <div className="table-responsive">
                                    ...
                                    <div className="d-flex flex-column">
                                        {/* Header */}
                                        <div className="d-flex border-bottom pb-2 mb-2" style={{ fontWeight: "bold" }}>
                                        ...
                                        {/* Rows */}
                                        {editRows.map((e, i) => (
                                            <div key={e.id || i} className="d-flex align-items-center mb-1">
